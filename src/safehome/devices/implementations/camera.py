...
from ..interfaces.camera import InterfaceCamera
...
class DeviceCamera(threading.Thread, InterfaceCamera):
    ...
    def set_id(self, id_):
        ...
        with self._lock:
            ...
            # Look for image in resources directory
            resources_dir = Path(__file__).parent.parent / 'resources' / 'cameras'
            fileName = resources_dir / f"camera{id_}.jpg"
