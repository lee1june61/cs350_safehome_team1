"""Control Panel abstract interface for SafeHome system.

Integrated from virtual_device_v3/device/device_control_panel_abstract.py
"""
...
class DeviceControlPanelAbstract(tk.Toplevel, ABC):
    """
    Abstract control panel interface.
