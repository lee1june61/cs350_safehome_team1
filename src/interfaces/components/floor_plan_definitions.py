...
DEVICES = {
    ...
    "S2": (0.189, 0.097, "sensor"),  # (115, 36)
    "S3": (0.058, 0.684, "sensor"),  # (35, 255)
    "S4": (0.741, 0.113, "sensor"),  # (450, 42)
    "S5": (0.959, 0.375, "sensor"),  # (582, 140)
    ...
    # Door Sensors (blue dots with S labels)
    "S1_blue": (0.486, 0.121, "door_sensor"),  # (295, 45)
    "S2_blue": (0.222, 0.925, "door_sensor"),  # (135, 345)
}
